    ...
    return (
        <>
            <div className="px-2">
                ...
                <div className="flex flex-col items-center w-full mt-4 bg-gradient-to-tr from-black/70 to-yellow-500/50 backdrop-blur-2xl rounded">
                    ...
                    <button className="backdrop-blur bg-black w-[90%] cursor-pointer text-amber-300 py-0.5 mb-2 font-bold shadow-lg flex flex-row justify-center rounded">
                ...
                <div className="flex flex-col items-center w-full mt-6 bg-gradient-to-tr from-black/70 to-blue-600/70 backdrop-blur-2xl rounded">
                    <div className="flex flex-row items-center justify-between w-full">
                        <div className="p-2 px-4 flex flex-col items-center w-20">
