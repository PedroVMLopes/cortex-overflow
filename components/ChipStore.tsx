        ...
        <div className="backdrop-blur-lg bg-black/30 border border-emerald-800">
            ...
            <div className="backdrop-blur pb-4">
                ...
                <div className="grid grid-cols-2 mt-4 px-4 gap-7">
                    <Chip description={"Faz a missão selecionada dar 5 de XP"} price={1} selectedTaskId={selectedTaskId} newXpReward={5}/>
                    <Chip description={"Faz a missão selecionada dar 10 de XP"} price={2} selectedTaskId={selectedTaskId} newXpReward={10}/>
                </div>
                <div>
