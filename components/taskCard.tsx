...
export const TaskCardComponent = ( { task, onTaskRemove, onRewardUpdate, onToggleCompletion, onToggleAttribute }: TaskCard ) => {
    ...
    return (
      <div className={`relative border ${xp_reward > 1 ? 'border-orange-500/60' : 'border-emerald-500/50'} font-mono shadow-xl overflow-hidden backdrop-blur-3xl bg-black text-emerald-500 ${is_completed ? 'bg-black opacity-30' : ''}`}>
